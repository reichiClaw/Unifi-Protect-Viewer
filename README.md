...
- 🕹️ **PTZ cameras** get on-screen controls in fullscreen — hold-to-move pan/tilt/zoom D-pad plus home, presets and patrol — no Stream Deck required
- 🎛️ **Stream Deck plugin** to switch views, pop a camera fullscreen, control PTZ (incl. hold-to-move pan/tilt/zoom), and step views
